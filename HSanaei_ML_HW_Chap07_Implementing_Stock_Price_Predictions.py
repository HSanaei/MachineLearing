'''
Python machine learning - Stock price prediction
by Regression Algorithm: Linear, Random Forest and SVR
'''
...
data_raw = pd.read_csv('19880101_20191231-smaller10.csv', index_col='Date')
data = generate_features(data_raw)

data 
start_train = '1992-01-02'
end_train = '2018-12-26'
...
''' Doing prediction with linear regression'''
...
''' Doing prediction with resgression forest'''
param_grid = {
    'max_depth': [30, 50],
